...
Scenario: Dependent_FA 
	...
	And I select TaxDependents as "1" 
	And I select Apply Coverage for "Me" 
	And I select Apply Coverage for "My Spouse" 
	And I select Apply Coverage for "My Dependent" 
	And I select Income as "MoreThan87000" 
	...
	When I click Add a person who needs coverage button 
	Then I should be on Add a person who needs health coverage Page 
	When I type First Name as "Baby" on Add Dependent Page 
	And I type Last Name as "Griffith" on Add Dependent Page 
	And I type month as "08" on Add Dependent Page 
	And I type day as "01" on Add Dependent Page 
	And I type year as "2019" on Add Dependent Page 
	And I select gender as "Female" on Add Dependent Page 
	And I select option as "Daughter/son (including adopted children)" for relationship drop down on Add Dependent Page 
	And I select option as "Daughter/son (including adopted children)" for relationship with spouse drop down on Add Dependent Page 
	And I click Save button on Add Dependent Page 
	Then I should be on Who needs health coverage? Page 
	...
	Then I Should be on Baby Information Page 
	And I select Baby doesn't have an SSN option 
	And I click Save button on User Information Page 

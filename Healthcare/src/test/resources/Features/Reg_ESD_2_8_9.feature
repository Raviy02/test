@regression @Reg_ESD_2_8_9 
Feature: Overall Record View (verify all buttons on ESD open and display information, verify there are no RBK issues). 

Scenario:
Overall Record View (verify all buttons on ESD open and display information, verify there are no RBK issues). 
...
Given I navigate to Login Page 
	...
	When I type Date of Birth as "01011987"
	...
	And I click Search by application id button on Eligibility Support Staff Desktop Page 
	And I click on First result in table 
	And I click on Verification Issues tab 
	And I click on Individual Verification Issue accordion 
	And I click on First entry with Verification status as "Pending Documentation" 
	And I click on Verification Issue accordion 
	And I click on Resolve Verification Issue button 
	...
	And I click on Verification Issues tab 
	And I click on Individual Verification Issue accordion
	Then I should see Verification Issue Status as "Resolved"
